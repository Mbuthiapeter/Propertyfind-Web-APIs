                  ...
                  <div class="panel-body">
                      <div class="col-md-12 col-sm-12">
                        ...
                        <ul class="nav navbar-nav">
                            <li><a href="admin/published.php" class="active">Published</a></li>
							<li><a href="admin/unpublished.php" >Unpublished</a></li>
                            <li><a href="admin/deactivated.php" >Deactivated</a></li>
                        </ul>
                    </div>                   
                  </div>                    
                </div>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
						  ...
						  <td align="center"><a href="admin/detailView.php?propertyId=<?php echo($row['id']) ?> "><span class="icons icon-eye" title="Detail View"></span></a>
						  </td>
                        </tr>
		<?php }	?>
...
<script src="admin/asset/js/plugins/datatables.bootstrap.min.js"></script>
