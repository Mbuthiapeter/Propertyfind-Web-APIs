...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="Propertyfind App v.1">
            ...
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="index.php" class="navbar-brand"> 
                 <img src="asset/img/logo.jpg" style="width:55px;height: 35px">
                </a>
						<?php
						$user = $db -> getUserName($userId);
						?>
                   ...
                   <ul class="dropdown-menu user-dropdown">
                     ...
                     <li class="more">
                      <ul>
						...
						<li></li>
                        <li><a href="logout.php"><span title="Logout" class="fa fa-lock"></span></a></li>
                        <li></li>
                      </ul>
                    </li>
                  </ul>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
					...
					<li class="ripple"><a href="index.php"><span class="fa-diamond fa"></span>Properties</a></li>
					<?php if($_SESSION["userType"] == 1){ ?>
					<li class="ripple"><a href="users.php"><span class="icons icon-people"></span>Users</a></li>
					<?php } ?>
					<!--<li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="icons icon-people"></span> Users
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                          <li><a href="">Lesama Users</a></li>
