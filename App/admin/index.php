                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
						  ...
						  foreach($featuredProperties as $row){
							  $notation = $db -> getNotation($row['property_listing']);
						  ?>						  
						  <tr>
                          <td><?php echo($notation.$row['id']) ?></td>
						  ...
						  <td align=""><a href="detailView.php?propertyId=<?php echo($row['id']) ?> "><span class="icons icon-eye" title="Detail View"></span></a>
							  <?php if($_SESSION["userType"] == 1){ ?>
							 <a href="deleteProperty.php?propertyId= <?php echo($row['id']) ?>" onClick="return confirm_delete('Are you sure you want to delete? This action cannot be undone!')"> <span class="icons icon-trash push-right" title="Delete Property"></span></a>
							  <?php } ?>
						  </td>
                        </tr>
		<?php }	?>
