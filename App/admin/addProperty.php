...
<div class="form-group col-lg-4">
	<label for="idnum">Location<font class="a">*</font></label> <input class="form-control " name="location" type="text" id="location" placeholder="Specify the location e.g Ruaka" required/>
</div>
