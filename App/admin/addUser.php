...
<div class="form-group col-lg-6">
	<label for="idnum">Email Address<font class="a">*</font></label>
	<input class="form-control " name="email" type="text" id="email" placeholder="Enter email" required/>
</div>
<div class="form-group col-lg-6">
	<label for="idnum">Username<font class="a">*</font></label>
	<input class="form-control " name="uname" type="text" id="uname" placeholder="Enter Username" required/>
</div>
<div class="form-group col-lg-6">
	<label for="idnum">Password<font class="a">*</font></label>
	<input class="form-control " name="password" type="text" id="password" placeholder="Assign Password" required/>
</div>
		<?php
