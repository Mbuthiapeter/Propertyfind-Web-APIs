...
if(isset($_POST['submit'])){   
	...
	$query = $db ->save_property($propertyType,$propertyListing,$location,$specificLocation, $amount, $manager, $bedrooms,$showers,$carParks,$description,$propertyUrl);
	
	$propertyId = $db ->lastId();
	...
	if($uploaded > 0){
	  echo'<script>javascript: alert("Property added")></script>';
