approval_statusapproval_statusapproval_statusapproval_statusapproval_statusapproval_statusapproval_statusapproval_statusapproval_statusapproval_statusapproval_status<?php
...
<!-- start: Content -->
            <div id="content">				
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Deactivated Properties</h3></div>
                    <div class="panel-body">
						<?php
						$featuredProperties = $db -> getDeactivatedProperties();
						?>
