...
<div class="form-group col-lg-6">
	...
	<select class="form-control " name="location" id="location" required>
		...
		<div class="form-group col-lg-6">
	<label for="idnum">Personal Info<font class="a">*</font></label> 
		...
		<div class="form-group col-lg-6">
	<label for="idnum">Rating<font class="a">*</font></label> <input class="form-control " name="rating" type="number" min="0" max="5" id="rating" placeholder="Enter full name" required/>
</div>
