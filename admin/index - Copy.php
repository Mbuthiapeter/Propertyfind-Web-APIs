...
?>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-12 col-sm-12">
                        <h3 class="animated fadeInLeft">Propertyfind - Add Property</h3>
                        <ul class="nav navbar-nav">
                            <li><a href="" class="active">Active Properties</a></li>
                            <li><a href="" >Deactivated Properties</a></li>
	...
	<form method="post" action="saveProperty.php" enctype="multipart/form-data">
		<!--<form class="registration" method="post" action="saveProperty.php" id="registration">-->
...
<div class="form-group col-lg-8">
	...
	<textarea class="form-control" name="description" id="description" rows="5" id="comment" placeholder="Describe the property fully" required></textarea>	
</div>								
